     ...
     generate() {
         ...
         for (let x = 1; x < this.columns - 1; x++) {
             for (let y = 1; y < this.rows - 1; y++) {
                 ...
                 if      ((this.cells[x][y] == 1) && (neighbors <= 1)) nextgen[x][y] = this.Loneliness();
                 //else if ((this.cells[x][y] == 1) && (neighbors <  2)) nextgen[x][y] = 0;
                 else if ((this.cells[x][y] == 1) && (neighbors >= 4)) nextgen[x][y] = this.Overpopulation();
